...
public class FAACLogsBeanInfo extends SimpleBeanInfo {
   ...
   private static BeanDescriptor getBdescriptor() {
      return new BeanDescriptor(FAACLogs.class, null);
   }
   ...
   private static PropertyDescriptor[] getPdescriptor() {
      ...
      try {
         properties[0] = new PropertyDescriptor("accessibleContext", FAACLogs.class, "getAccessibleContext", null);
         properties[1] = new PropertyDescriptor("actionMap", FAACLogs.class, "getActionMap", "setActionMap");
         properties[2] = new PropertyDescriptor("alignmentX", FAACLogs.class, "getAlignmentX", "setAlignmentX");
         properties[3] = new PropertyDescriptor("alignmentY", FAACLogs.class, "getAlignmentY", "setAlignmentY");
         properties[4] = new PropertyDescriptor("ancestorListeners", FAACLogs.class, "getAncestorListeners", null);
         properties[5] = new PropertyDescriptor("autoscrolls", FAACLogs.class, "getAutoscrolls", "setAutoscrolls");
         properties[6] = new PropertyDescriptor("background", FAACLogs.class, "getBackground", "setBackground");
         properties[7] = new PropertyDescriptor("backgroundSet", FAACLogs.class, "isBackgroundSet", null);
         properties[8] = new PropertyDescriptor("baselineResizeBehavior", FAACLogs.class, "getBaselineResizeBehavior", null);
         properties[9] = new PropertyDescriptor("border", FAACLogs.class, "getBorder", "setBorder");
         properties[10] = new PropertyDescriptor("bounds", FAACLogs.class, "getBounds", "setBounds");
         properties[11] = new PropertyDescriptor("colorModel", FAACLogs.class, "getColorModel", null);
         properties[12] = new IndexedPropertyDescriptor("component", FAACLogs.class, null, null, "getComponent", null);
         properties[13] = new PropertyDescriptor("componentCount", FAACLogs.class, "getComponentCount", null);
         properties[14] = new PropertyDescriptor("componentListeners", FAACLogs.class, "getComponentListeners", null);
         properties[15] = new PropertyDescriptor("componentOrientation", FAACLogs.class, "getComponentOrientation", "setComponentOrientation");
         properties[16] = new PropertyDescriptor("componentPopupMenu", FAACLogs.class, "getComponentPopupMenu", "setComponentPopupMenu");
         properties[17] = new PropertyDescriptor("components", FAACLogs.class, "getComponents", null);
         properties[18] = new PropertyDescriptor("containerListeners", FAACLogs.class, "getContainerListeners", null);
         properties[19] = new PropertyDescriptor("cursor", FAACLogs.class, "getCursor", "setCursor");
         properties[20] = new PropertyDescriptor("cursorSet", FAACLogs.class, "isCursorSet", null);
         properties[21] = new PropertyDescriptor("debugGraphicsOptions", FAACLogs.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions");
         properties[22] = new PropertyDescriptor("displayable", FAACLogs.class, "isDisplayable", null);
         properties[23] = new PropertyDescriptor("doubleBuffered", FAACLogs.class, "isDoubleBuffered", "setDoubleBuffered");
         properties[24] = new PropertyDescriptor("dropTarget", FAACLogs.class, "getDropTarget", "setDropTarget");
         properties[25] = new PropertyDescriptor("enabled", FAACLogs.class, "isEnabled", "setEnabled");
         properties[26] = new PropertyDescriptor("focusable", FAACLogs.class, "isFocusable", "setFocusable");
         properties[27] = new PropertyDescriptor("focusCycleRoot", FAACLogs.class, "isFocusCycleRoot", "setFocusCycleRoot");
         properties[28] = new PropertyDescriptor("focusCycleRootAncestor", FAACLogs.class, "getFocusCycleRootAncestor", null);
         properties[29] = new PropertyDescriptor("focusListeners", FAACLogs.class, "getFocusListeners", null);
         properties[30] = new PropertyDescriptor("focusOwner", FAACLogs.class, "isFocusOwner", null);
         properties[31] = new PropertyDescriptor("focusTraversable", FAACLogs.class, "isFocusTraversable", null);
         properties[32] = new IndexedPropertyDescriptor("focusTraversalKeys", FAACLogs.class, null, null, null, "setFocusTraversalKeys");
         properties[33] = new PropertyDescriptor("focusTraversalKeysEnabled", FAACLogs.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled");
         properties[34] = new PropertyDescriptor("focusTraversalPolicy", FAACLogs.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy");
         properties[35] = new PropertyDescriptor(
            "focusTraversalPolicyProvider", FAACLogs.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider"
         );
         properties[36] = new PropertyDescriptor("focusTraversalPolicySet", FAACLogs.class, "isFocusTraversalPolicySet", null);
         properties[37] = new PropertyDescriptor("font", FAACLogs.class, "getFont", "setFont");
         properties[38] = new PropertyDescriptor("fontSet", FAACLogs.class, "isFontSet", null);
         properties[39] = new PropertyDescriptor("foreground", FAACLogs.class, "getForeground", "setForeground");
         properties[40] = new PropertyDescriptor("foregroundSet", FAACLogs.class, "isForegroundSet", null);
         properties[41] = new PropertyDescriptor("graphics", FAACLogs.class, "getGraphics", null);
         properties[42] = new PropertyDescriptor("graphicsConfiguration", FAACLogs.class, "getGraphicsConfiguration", null);
         properties[43] = new PropertyDescriptor("height", FAACLogs.class, "getHeight", null);
         properties[44] = new PropertyDescriptor("hierarchyBoundsListeners", FAACLogs.class, "getHierarchyBoundsListeners", null);
         properties[45] = new PropertyDescriptor("hierarchyListeners", FAACLogs.class, "getHierarchyListeners", null);
         properties[46] = new PropertyDescriptor("ignoreRepaint", FAACLogs.class, "getIgnoreRepaint", "setIgnoreRepaint");
         properties[47] = new PropertyDescriptor("inheritsPopupMenu", FAACLogs.class, "getInheritsPopupMenu", "setInheritsPopupMenu");
         properties[48] = new PropertyDescriptor("inputContext", FAACLogs.class, "getInputContext", null);
         properties[49] = new PropertyDescriptor("inputMap", FAACLogs.class, "getInputMap", null);
         properties[50] = new PropertyDescriptor("inputMethodListeners", FAACLogs.class, "getInputMethodListeners", null);
         properties[51] = new PropertyDescriptor("inputMethodRequests", FAACLogs.class, "getInputMethodRequests", null);
         properties[52] = new PropertyDescriptor("inputVerifier", FAACLogs.class, "getInputVerifier", "setInputVerifier");
         properties[53] = new PropertyDescriptor("insets", FAACLogs.class, "getInsets", null);
         properties[54] = new PropertyDescriptor("keyListeners", FAACLogs.class, "getKeyListeners", null);
         properties[55] = new PropertyDescriptor("layout", FAACLogs.class, "getLayout", "setLayout");
         properties[56] = new PropertyDescriptor("lightweight", FAACLogs.class, "isLightweight", null);
         properties[57] = new PropertyDescriptor("locale", FAACLogs.class, "getLocale", "setLocale");
         properties[58] = new PropertyDescriptor("location", FAACLogs.class, "getLocation", "setLocation");
         properties[59] = new PropertyDescriptor("locationOnScreen", FAACLogs.class, "getLocationOnScreen", null);
         properties[60] = new PropertyDescriptor("managingFocus", FAACLogs.class, "isManagingFocus", null);
         properties[61] = new PropertyDescriptor("maximumSize", FAACLogs.class, "getMaximumSize", "setMaximumSize");
         properties[62] = new PropertyDescriptor("maximumSizeSet", FAACLogs.class, "isMaximumSizeSet", null);
         properties[63] = new PropertyDescriptor("minimumSize", FAACLogs.class, "getMinimumSize", "setMinimumSize");
         properties[64] = new PropertyDescriptor("minimumSizeSet", FAACLogs.class, "isMinimumSizeSet", null);
         properties[65] = new PropertyDescriptor("mouseListeners", FAACLogs.class, "getMouseListeners", null);
         properties[66] = new PropertyDescriptor("mouseMotionListeners", FAACLogs.class, "getMouseMotionListeners", null);
         properties[67] = new PropertyDescriptor("mousePosition", FAACLogs.class, "getMousePosition", null);
         properties[68] = new PropertyDescriptor("mouseWheelListeners", FAACLogs.class, "getMouseWheelListeners", null);
         properties[69] = new PropertyDescriptor("name", FAACLogs.class, "getName", "setName");
         properties[70] = new PropertyDescriptor("nextFocusableComponent", FAACLogs.class, "getNextFocusableComponent", "setNextFocusableComponent");
         properties[71] = new PropertyDescriptor("opaque", FAACLogs.class, "isOpaque", "setOpaque");
         properties[72] = new PropertyDescriptor("optimizedDrawingEnabled", FAACLogs.class, "isOptimizedDrawingEnabled", null);
         properties[73] = new PropertyDescriptor("paintingForPrint", FAACLogs.class, "isPaintingForPrint", null);
         properties[74] = new PropertyDescriptor("paintingTile", FAACLogs.class, "isPaintingTile", null);
         properties[75] = new PropertyDescriptor("parent", FAACLogs.class, "getParent", null);
         properties[76] = new PropertyDescriptor("peer", FAACLogs.class, "getPeer", null);
         properties[77] = new PropertyDescriptor("preferredSize", FAACLogs.class, "getPreferredSize", "setPreferredSize");
         properties[78] = new PropertyDescriptor("preferredSizeSet", FAACLogs.class, "isPreferredSizeSet", null);
         properties[79] = new PropertyDescriptor("propertyChangeListeners", FAACLogs.class, "getPropertyChangeListeners", null);
         properties[80] = new PropertyDescriptor("registeredKeyStrokes", FAACLogs.class, "getRegisteredKeyStrokes", null);
         properties[81] = new PropertyDescriptor("requestFocusEnabled", FAACLogs.class, "isRequestFocusEnabled", "setRequestFocusEnabled");
         properties[82] = new PropertyDescriptor("rootPane", FAACLogs.class, "getRootPane", null);
         properties[83] = new PropertyDescriptor("showing", FAACLogs.class, "isShowing", null);
         properties[84] = new PropertyDescriptor("size", FAACLogs.class, "getSize", "setSize");
         properties[85] = new PropertyDescriptor("toolkit", FAACLogs.class, "getToolkit", null);
         properties[86] = new PropertyDescriptor("toolTipText", FAACLogs.class, "getToolTipText", "setToolTipText");
         properties[87] = new PropertyDescriptor("topLevelAncestor", FAACLogs.class, "getTopLevelAncestor", null);
         properties[88] = new PropertyDescriptor("transferHandler", FAACLogs.class, "getTransferHandler", "setTransferHandler");
         properties[89] = new PropertyDescriptor("treeLock", FAACLogs.class, "getTreeLock", null);
         properties[90] = new PropertyDescriptor("UI", FAACLogs.class, "getUI", "setUI");
         properties[91] = new PropertyDescriptor("UIClassID", FAACLogs.class, "getUIClassID", null);
         properties[92] = new PropertyDescriptor("valid", FAACLogs.class, "isValid", null);
         properties[93] = new PropertyDescriptor("validateRoot", FAACLogs.class, "isValidateRoot", null);
         properties[94] = new PropertyDescriptor("verifyInputWhenFocusTarget", FAACLogs.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget");
         properties[95] = new PropertyDescriptor("vetoableChangeListeners", FAACLogs.class, "getVetoableChangeListeners", null);
         properties[96] = new PropertyDescriptor("visible", FAACLogs.class, "isVisible", "setVisible");
         properties[97] = new PropertyDescriptor("visibleRect", FAACLogs.class, "getVisibleRect", null);
         properties[98] = new PropertyDescriptor("width", FAACLogs.class, "getWidth", null);
         properties[99] = new PropertyDescriptor("x", FAACLogs.class, "getX", null);
         properties[100] = new PropertyDescriptor("y", FAACLogs.class, "getY", null);
   ...
   private static EventSetDescriptor[] getEdescriptor() {
      ...
      try {
         ...
         eventSets[3] = new EventSetDescriptor(
            FAACLogs.class, "focusListener", FocusListener.class, new String[]{"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener"
         );
         ...
         eventSets[5] = new EventSetDescriptor(
            FAACLogs.class, "hierarchyListener", HierarchyListener.class, new String[]{"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener"
         );
         ...
         eventSets[7] = new EventSetDescriptor(
            FAACLogs.class, "keyListener", KeyListener.class, new String[]{"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener"
         );
