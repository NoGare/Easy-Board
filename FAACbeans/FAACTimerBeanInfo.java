...
public class FAACTimerBeanInfo extends SimpleBeanInfo {
   ...
   private static BeanDescriptor getBdescriptor() {
      return new BeanDescriptor(FAACTimer.class, null);
   }
   ...
   private static PropertyDescriptor[] getPdescriptor() {
      ...
      try {
         properties[0] = new PropertyDescriptor("accessibleContext", FAACTimer.class, "getAccessibleContext", null);
         properties[1] = new PropertyDescriptor("actionMap", FAACTimer.class, "getActionMap", "setActionMap");
         properties[2] = new PropertyDescriptor("alignmentX", FAACTimer.class, "getAlignmentX", "setAlignmentX");
         properties[3] = new PropertyDescriptor("alignmentY", FAACTimer.class, "getAlignmentY", "setAlignmentY");
         properties[4] = new PropertyDescriptor("ancestorListeners", FAACTimer.class, "getAncestorListeners", null);
         properties[5] = new PropertyDescriptor("autoscrolls", FAACTimer.class, "getAutoscrolls", "setAutoscrolls");
         properties[6] = new PropertyDescriptor("background", FAACTimer.class, "getBackground", "setBackground");
         properties[7] = new PropertyDescriptor("backgroundSet", FAACTimer.class, "isBackgroundSet", null);
         properties[8] = new PropertyDescriptor("baselineResizeBehavior", FAACTimer.class, "getBaselineResizeBehavior", null);
         properties[9] = new PropertyDescriptor("border", FAACTimer.class, "getBorder", "setBorder");
         properties[10] = new PropertyDescriptor("bounds", FAACTimer.class, "getBounds", "setBounds");
         properties[11] = new PropertyDescriptor("colorModel", FAACTimer.class, "getColorModel", null);
         properties[12] = new IndexedPropertyDescriptor("component", FAACTimer.class, null, null, "getComponent", null);
         properties[13] = new PropertyDescriptor("componentCount", FAACTimer.class, "getComponentCount", null);
         properties[14] = new PropertyDescriptor("componentListeners", FAACTimer.class, "getComponentListeners", null);
         properties[15] = new PropertyDescriptor("componentOrientation", FAACTimer.class, "getComponentOrientation", "setComponentOrientation");
         properties[16] = new PropertyDescriptor("componentPopupMenu", FAACTimer.class, "getComponentPopupMenu", "setComponentPopupMenu");
         properties[17] = new PropertyDescriptor("components", FAACTimer.class, "getComponents", null);
         properties[18] = new PropertyDescriptor("containerListeners", FAACTimer.class, "getContainerListeners", null);
         properties[19] = new PropertyDescriptor("cursor", FAACTimer.class, "getCursor", "setCursor");
         properties[20] = new PropertyDescriptor("cursorSet", FAACTimer.class, "isCursorSet", null);
         properties[21] = new PropertyDescriptor("debugGraphicsOptions", FAACTimer.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions");
         properties[22] = new PropertyDescriptor("displayable", FAACTimer.class, "isDisplayable", null);
         properties[23] = new PropertyDescriptor("doubleBuffered", FAACTimer.class, "isDoubleBuffered", "setDoubleBuffered");
         properties[24] = new PropertyDescriptor("dropTarget", FAACTimer.class, "getDropTarget", "setDropTarget");
         properties[25] = new PropertyDescriptor("enabled", FAACTimer.class, "isEnabled", "setEnabled");
         properties[26] = new PropertyDescriptor("focusable", FAACTimer.class, "isFocusable", "setFocusable");
         properties[27] = new PropertyDescriptor("focusCycleRoot", FAACTimer.class, "isFocusCycleRoot", "setFocusCycleRoot");
         properties[28] = new PropertyDescriptor("focusCycleRootAncestor", FAACTimer.class, "getFocusCycleRootAncestor", null);
         properties[29] = new PropertyDescriptor("focusListeners", FAACTimer.class, "getFocusListeners", null);
         properties[30] = new PropertyDescriptor("focusOwner", FAACTimer.class, "isFocusOwner", null);
         properties[31] = new PropertyDescriptor("focusTraversable", FAACTimer.class, "isFocusTraversable", null);
         properties[32] = new IndexedPropertyDescriptor("focusTraversalKeys", FAACTimer.class, null, null, null, "setFocusTraversalKeys");
         properties[33] = new PropertyDescriptor("focusTraversalKeysEnabled", FAACTimer.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled");
         properties[34] = new PropertyDescriptor("focusTraversalPolicy", FAACTimer.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy");
         properties[35] = new PropertyDescriptor(
            "focusTraversalPolicyProvider", FAACTimer.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider"
         );
         properties[36] = new PropertyDescriptor("focusTraversalPolicySet", FAACTimer.class, "isFocusTraversalPolicySet", null);
         properties[37] = new PropertyDescriptor("font", FAACTimer.class, "getFont", "setFont");
         properties[38] = new PropertyDescriptor("fontSet", FAACTimer.class, "isFontSet", null);
         properties[39] = new PropertyDescriptor("foreground", FAACTimer.class, "getForeground", "setForeground");
         properties[40] = new PropertyDescriptor("foregroundSet", FAACTimer.class, "isForegroundSet", null);
         properties[41] = new PropertyDescriptor("graphics", FAACTimer.class, "getGraphics", null);
         properties[42] = new PropertyDescriptor("graphicsConfiguration", FAACTimer.class, "getGraphicsConfiguration", null);
         properties[43] = new PropertyDescriptor("height", FAACTimer.class, "getHeight", null);
         properties[44] = new PropertyDescriptor("hierarchyBoundsListeners", FAACTimer.class, "getHierarchyBoundsListeners", null);
         properties[45] = new PropertyDescriptor("hierarchyListeners", FAACTimer.class, "getHierarchyListeners", null);
         properties[46] = new PropertyDescriptor("ignoreRepaint", FAACTimer.class, "getIgnoreRepaint", "setIgnoreRepaint");
         properties[47] = new PropertyDescriptor("inheritsPopupMenu", FAACTimer.class, "getInheritsPopupMenu", "setInheritsPopupMenu");
         properties[48] = new PropertyDescriptor("inputContext", FAACTimer.class, "getInputContext", null);
         properties[49] = new PropertyDescriptor("inputMap", FAACTimer.class, "getInputMap", null);
         properties[50] = new PropertyDescriptor("inputMethodListeners", FAACTimer.class, "getInputMethodListeners", null);
         properties[51] = new PropertyDescriptor("inputMethodRequests", FAACTimer.class, "getInputMethodRequests", null);
         properties[52] = new PropertyDescriptor("inputVerifier", FAACTimer.class, "getInputVerifier", "setInputVerifier");
         properties[53] = new PropertyDescriptor("insets", FAACTimer.class, "getInsets", null);
         properties[54] = new PropertyDescriptor("keyListeners", FAACTimer.class, "getKeyListeners", null);
         properties[55] = new PropertyDescriptor("layout", FAACTimer.class, "getLayout", "setLayout");
         properties[56] = new PropertyDescriptor("lightweight", FAACTimer.class, "isLightweight", null);
         properties[57] = new PropertyDescriptor("locale", FAACTimer.class, "getLocale", "setLocale");
         properties[58] = new PropertyDescriptor("location", FAACTimer.class, "getLocation", "setLocation");
         properties[59] = new PropertyDescriptor("locationOnScreen", FAACTimer.class, "getLocationOnScreen", null);
         properties[60] = new PropertyDescriptor("managingFocus", FAACTimer.class, "isManagingFocus", null);
         properties[61] = new PropertyDescriptor("maximumSize", FAACTimer.class, "getMaximumSize", "setMaximumSize");
         properties[62] = new PropertyDescriptor("maximumSizeSet", FAACTimer.class, "isMaximumSizeSet", null);
         properties[63] = new PropertyDescriptor("minimumSize", FAACTimer.class, "getMinimumSize", "setMinimumSize");
         properties[64] = new PropertyDescriptor("minimumSizeSet", FAACTimer.class, "isMinimumSizeSet", null);
         properties[65] = new PropertyDescriptor("mouseListeners", FAACTimer.class, "getMouseListeners", null);
         properties[66] = new PropertyDescriptor("mouseMotionListeners", FAACTimer.class, "getMouseMotionListeners", null);
         properties[67] = new PropertyDescriptor("mousePosition", FAACTimer.class, "getMousePosition", null);
         properties[68] = new PropertyDescriptor("mouseWheelListeners", FAACTimer.class, "getMouseWheelListeners", null);
         properties[69] = new PropertyDescriptor("name", FAACTimer.class, "getName", "setName");
         properties[70] = new PropertyDescriptor("nextFocusableComponent", FAACTimer.class, "getNextFocusableComponent", "setNextFocusableComponent");
         properties[71] = new PropertyDescriptor("opaque", FAACTimer.class, "isOpaque", "setOpaque");
         properties[72] = new PropertyDescriptor("optimizedDrawingEnabled", FAACTimer.class, "isOptimizedDrawingEnabled", null);
         properties[73] = new PropertyDescriptor("paintingForPrint", FAACTimer.class, "isPaintingForPrint", null);
         properties[74] = new PropertyDescriptor("paintingTile", FAACTimer.class, "isPaintingTile", null);
         properties[75] = new PropertyDescriptor("parent", FAACTimer.class, "getParent", null);
         properties[76] = new PropertyDescriptor("peer", FAACTimer.class, "getPeer", null);
         properties[77] = new PropertyDescriptor("preferredSize", FAACTimer.class, "getPreferredSize", "setPreferredSize");
         properties[78] = new PropertyDescriptor("preferredSizeSet", FAACTimer.class, "isPreferredSizeSet", null);
         properties[79] = new PropertyDescriptor("propertyChangeListeners", FAACTimer.class, "getPropertyChangeListeners", null);
         properties[80] = new PropertyDescriptor("registeredKeyStrokes", FAACTimer.class, "getRegisteredKeyStrokes", null);
         properties[81] = new PropertyDescriptor("requestFocusEnabled", FAACTimer.class, "isRequestFocusEnabled", "setRequestFocusEnabled");
         properties[82] = new PropertyDescriptor("rootPane", FAACTimer.class, "getRootPane", null);
         properties[83] = new PropertyDescriptor("showing", FAACTimer.class, "isShowing", null);
         properties[84] = new PropertyDescriptor("size", FAACTimer.class, "getSize", "setSize");
         properties[85] = new PropertyDescriptor("toolkit", FAACTimer.class, "getToolkit", null);
         properties[86] = new PropertyDescriptor("toolTipText", FAACTimer.class, "getToolTipText", "setToolTipText");
         properties[87] = new PropertyDescriptor("topLevelAncestor", FAACTimer.class, "getTopLevelAncestor", null);
         properties[88] = new PropertyDescriptor("transferHandler", FAACTimer.class, "getTransferHandler", "setTransferHandler");
         properties[89] = new PropertyDescriptor("treeLock", FAACTimer.class, "getTreeLock", null);
         properties[90] = new PropertyDescriptor("UI", FAACTimer.class, "getUI", "setUI");
         properties[91] = new PropertyDescriptor("UIClassID", FAACTimer.class, "getUIClassID", null);
         properties[92] = new PropertyDescriptor("valid", FAACTimer.class, "isValid", null);
         properties[93] = new PropertyDescriptor("validateRoot", FAACTimer.class, "isValidateRoot", null);
         properties[94] = new PropertyDescriptor(
            "verifyInputWhenFocusTarget", FAACTimer.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget"
         );
         properties[95] = new PropertyDescriptor("vetoableChangeListeners", FAACTimer.class, "getVetoableChangeListeners", null);
         properties[96] = new PropertyDescriptor("visible", FAACTimer.class, "isVisible", "setVisible");
         properties[97] = new PropertyDescriptor("visibleRect", FAACTimer.class, "getVisibleRect", null);
         properties[98] = new PropertyDescriptor("width", FAACTimer.class, "getWidth", null);
         properties[99] = new PropertyDescriptor("x", FAACTimer.class, "getX", null);
         properties[100] = new PropertyDescriptor("y", FAACTimer.class, "getY", null);
   ...
   private static EventSetDescriptor[] getEdescriptor() {
      ...
      try {
         ...
         eventSets[3] = new EventSetDescriptor(
            FAACTimer.class, "focusListener", FocusListener.class, new String[]{"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener"
         );
         ...
         eventSets[5] = new EventSetDescriptor(
            FAACTimer.class, "hierarchyListener", HierarchyListener.class, new String[]{"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener"
         );
         ...
         eventSets[7] = new EventSetDescriptor(
            FAACTimer.class, "keyListener", KeyListener.class, new String[]{"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener"
         );
